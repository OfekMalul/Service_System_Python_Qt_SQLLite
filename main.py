...
class MyForm(QDialog):
    ...
    def __init__(self, db_file=None):
        ...
        self.ui = loadUi('project_7_Ofek_Malul.ui', self)
        ...
        self.pushButtonDelete.clicked.connect(self.deleteRow)
    ...
    def addRow(self):
        ...
        self.ui.lineEditMaintNumber.setText(str(row + 1))
        self.ui.dateEdit.setDate(QDate(2023, 2, 4))
        self.ui.lineEditMileage.setText("New Task")
        self.ui.lineEditPerformed.setText("New Task")
        self.ui.plainTextEdit.setPlainText("Ofek")
        self.ui.lineEditCost.setText(" ")
        self.ui.lineEditDateDue.setText(" ")
        self.ui.lineEditMileageDue.setText(" ")
        self.mapper.submit()
